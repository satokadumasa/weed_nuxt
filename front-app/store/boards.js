...
export const actions = {
    ...
    asyncBoards({ commit }, params) {
      ...
      return this.$axios
        .$get("/normal/boards/?page=" + params.page + searchData)
        .then((response) => {
    ...
    asyncBoardUpdate({ commit }, params) {
      ...
      return this.$axios
        .$put("/normal/boards/" + params.id , params)
        .then((response) => {
    ...
    asyncBoardDelete({ commit }, params) {
      ...
      return this.$axios
        .$delete("/normal/boards/" + params.id)
        .then((response) => {
          return response;
        });
    },
    asyncBoardCommentCreate({ commit }, params) {
      ...
      return this.$axios
        .$post("/normal/board_comments/", params)
        .then((response) => {
          console.log("asyncBoardCommentCreate() response:" + JSON.stringify(response));
          commit("SET_BOARDS", response.boards);
          return response;
    ...
    asyncBoardComments({ commit }, params) {
      ...
      return this.$axios
        .$get("/normal/board_comments/?board_id=" + params.board_id)
        .then((response) => {
    ...
    asyncBoardBookmarkCreate({ commit }, params) {
      ...
      return this.$axios
        .$post("/normal/board_bookmarks/", params)
        .then((response) => {
          return response;
        });
    },
    searchBoards({ commit }, params) {
      ...
      return this.$axios
        .$get("/normal/boards/?page=1" + searchData)
        .then((response) => {
          commit("SET_BOARDS", response.boards);
          return response;
        });
