...
export const actions = {
    ...
    asyncBoards({ commit }, params) {
      ...
      return this.$axios
        .$get("/administrator/boards/?page=" + params.page + searchData)
        .then((response) => {
    ...
    asyncBoard({ commit }, params) {
      ...
      return this.$axios
        .$get("/administrator/boards/" + params.id)
        .then((response) => {
    ...
    asyncBoardCreate({ commit }, params) {
      ...
      return this.$axios
        .$post("/administrator/boards/", params)
        .then((response) => {
          commit("SET_BOARDS", response.boards);
          return response;
        });
    ...
    asyncBoardUpdate({ commit }, params) {
      ...
      return this.$axios
        .$put("/administrator/boards/" + params.id , params)
        .then((response) => {
    ...
    asyncBoardDelete({ commit }, params) {
      ...
      return this.$axios
        .$delete("/administrator/boards/" + params.id)
        .then((response) => {
          return response;
        });
    },
    asyncBoardCommentCreate({ commit }, params) {
      ...
      return this.$axios
        .$post("/administrator/board_comments/", params)
        .then((response) => {
          console.log("asyncBoardCommentCreate() response:" + JSON.stringify(response));
          commit("SET_BOARDS", response.boards);
          return response;
